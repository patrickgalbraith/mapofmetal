        ...
        <div className="Modal SettingsModal">
          ...
          <ul className="Modal-settings">
            <li>
              ...
              <div
                className="Modal-settings-value"
                onClick={() => this.toggleStreamQuality()}
              >
                {quality}
              </div>
              <div className="Modal-settings-description">
                change the quality of the youtube stream, choose from 'low'
                where each video is approx 3mb, 'medium' around 6mb, 'high'
                around 20mb, etc... please note quality won't chnage until next
                track loads
              </div>
            </li>
          </ul>
