...
class MapLayer extends Component {
  ...
  parsePosition(position: MapCenterPoint): [number, number] {
    ...
    if (position[0] === 'left') newPosition[0] = 0;else if (position[0] === 'right') newPosition[0] = IMAGE_WIDTH;else newPosition[0] = position[0];

    if (position[1] === 'top') newPosition[1] = 0;else if (position[1] === 'bottom') newPosition[1] = IMAGE_HEIGHT;else newPosition[1] = position[1];
  ...
  componentDidMount() {
    ...
    if (document.body) document.body.appendChild(this.viewerElement);
